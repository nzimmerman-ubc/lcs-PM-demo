...
We will download data from July 1 2020 - December 31 2020 (6 months - including a wildfire period).
...
weather_1h <- weather_dl(station_ids = closest_station$station_id,start="2020-07-01",end="2020-12-31",interval="hour")
...
# Model H: Only include sensor (identical to Part 2, accuracy calculations)
lm_model.H <- lm(FEM ~ Burnaby1,
                    data = data_train)
